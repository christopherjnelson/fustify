...
- Brief player-colored combat beams for other players and bots on the globe and directional minimap action cues for reinforcement, combat, capture movement, and fortification, plus an opt-in Follow Action camera mode that yields immediately to manual control
