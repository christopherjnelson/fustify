...
Hard-invalid conditions are: missing or empty ownership, territory or army spread above one, a fully owned/single-owner gameplay continent, at least 80% of a five-or-more-territory position in one region, no strategic adjacency, sea-route or gateway ownership above the table average plus the greater of two or 75% of that average, majority control of three or more continents, or a territory with no army. Small or unusual worlds that cannot meet those constraints exhaust the same bounded deterministic search and report the reason. A technically valid Poor layout requires explicit confirmation before play. This remains a practical playtest heuristic, not a mathematical fairness proof.
